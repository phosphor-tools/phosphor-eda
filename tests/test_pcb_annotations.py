...
class TestResolveAnnotations:
    def test_box_and_pointer(self, board: Board) -> None:
        spec = AnnotationSpec(
    ...
    def test_content_bbox_encompasses_annotations(self, board: Board) -> None:
        spec = AnnotationSpec(
    ...
    def test_legend_resolved(self, board: Board) -> None:
        spec = AnnotationSpec(
            boxes=[],
            pointers=[],
            labels=[],
    ...
    def test_label_with_connector(self, board: Board) -> None:
    ...
    def test_label_without_target_no_connector(self, board: Board) -> None:
    ...
    def test_net_pointer(self, board: Board) -> None:
    ...
    def test_back_side_auto_margin_uses_rendered_view(self, board: Board) -> None:
    ...
    def test_back_side_position_hint_is_rendered_view(self, board: Board) -> None:
    ...
    def test_empty_spec_returns_empty(self, board: Board) -> None:
    ...
    def test_box_label_in_margin(self, board: Board) -> None:
    ...
    def test_box_label_has_connector(self, board: Board) -> None:
    ...
    def test_box_label_anchor_comes_from_margin(self, board: Board) -> None:
    ...
    def test_pointer_label_anchor_comes_from_margin(self, board: Board) -> None:
    ...
    def test_label_anchor_comes_from_margin(self, board: Board) -> None:
    ...
    def test_label_dimensions_populated(self, board: Board) -> None:
    ...
    def test_no_label_overlap(self, board: Board) -> None:
    ...
    def test_font_size_stored(self, board: Board) -> None:
