"""Axis-aligned wire segment index for Altium schematic connectivity.

Altium wires and buses are axis-aligned, so segments can be indexed by their
constant coordinate and queried with binary search instead of a linear scan.
"""
